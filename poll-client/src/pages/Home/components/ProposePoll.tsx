...
type ProposePollProp = {
  onPollPropose: any,
}

export default function ProposePoll({onPollPropose} : ProposePollProp) {
        ...
        <PageContainer>
          <PageMain>
            <PageContent>
              ...
              <ActionButton disabled={!validate} onClick={onPropose} variant="contained" color="primary">KAYDET</ActionButton>
            </PageContent>
          </PageMain>
        </PageContainer>
